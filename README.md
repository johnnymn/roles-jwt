# Roles And Permissions For Laravel 5 JWT based authentication

Powerful package for handling roles and permissions in Laravel 5 (5.1) JWT based authentication.
...
Publish the package config file and migrations to your application. Run these commands inside your terminal.
    ...
    php artisan vendor:publish --provider="Johnnymn\Sim\Roles\RolesServiceProvider" --tag=config
    php artisan vendor:publish --provider="Johnnymn\Sim\Roles\RolesServiceProvider" --tag=migrations
...
protected $routeMiddleware = [
    ...
    'role' => Johnnymn\Sim\Roles\Middleware\VerifyRole::class,
    'permission' => Johnnymn\Sim\Roles\Middleware\VerifyPermission::class,
    'level' => Johnnymn\Sim\Roles\Middleware\VerifyLevel::class,
];
```
...
It throws `Johnnymn\Sim\Roles\Exceptions\RoleDeniedException`, `Johnnymn\Sim\Roles\Exceptions\PermissionDeniedException` or `Johnnymn\Sim\Roles\Exceptions\LevelDeniedException` exceptions if it goes wrong.
...
For more information, please have a look at [HasRoleAndPermission](https://github.com/johnnymn/roles-jwt/blob/master/src/Contracts/HasRoleAndPermission.php) contract.
